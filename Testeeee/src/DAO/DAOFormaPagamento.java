...
* @author Maria Lima
*/
public class DAOFormaPagamento extends ConexaoMsql {
    ...
    public int salvarFormaPagamentoDAO(ModelFormaPagamento pModelFormaPagamento){
        try {
            ...
            return this.insertSQL(
                "INSERT INTO tbl_formar_pagamento ("
                    + "pk_id_for_pag,"
                    + "descricao_for_pag,"
                    + "desconto_for_pag,"
                    + "parcelas_for_pag,"
    ...
    public boolean atualizarFormaPagamentoDAO(ModelFormaPagamento pModelFormaPagamento){
        try {
            ...
            return this.executarUpdateDeleteSQL(
                "UPDATE tbl_formar_pagamento SET "
    ...
    */
    public boolean excluirFormaPagamentoDAO(int pIdForPag){
        try {
            this.conectar();
            return this.executarUpdateDeleteSQL(
                "DELETE FROM tbl_formar_pagamento "
                + " WHERE "
                    + "pk_id_for_pag = '" + pIdForPag + "'"
                + ";"
            );
